...
if ($html -notlike '*heroCanvas*') { throw '용사 게임 캔버스가 없습니다.' }
if ($html -notlike '*attackButton*') { throw '공격 버튼이 없습니다.' }
...
if ($js -notlike '*attack*') { throw '공격 처리가 없습니다.' }
if ($js -like '*snake*') { throw '지렁이 게임 코드가 남아 있습니다.' }
